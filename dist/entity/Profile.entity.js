...
(0, tslib_1.__decorate)([
    (0, typeorm_1.OneToMany)(type => Account_entity_1.Transaction, transaction => transaction.profile),
    (0, typeorm_1.JoinColumn)({ name: 'transaction' }),
    (0, tslib_1.__metadata)("design:type", Array)
], Profile.prototype, "transactions", void 0);
(0, tslib_1.__decorate)([
    (0, typeorm_1.OneToMany)(type => Shared_entity_1.Address, address => address.profile),
