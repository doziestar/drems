...
const limiters_1 = require("../utils/limiters");
...
class AuthRoute {
    ...
    initializeRoutes() {
        this.router.post(`${this.path}signup`, (0, validation_middleware_1.default)(users_dto_1.CreateUserDto, 'body', true), limiters_1.createAccountLimiter, this.authController.signUp);
